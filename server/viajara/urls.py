...
from .views import HelloWorldView, LogoutAndBlacklistRefreshToken, ListEntryCreate, ObtainTokenPair, PlaceCreate, PlaceSingleView, PlaceView, UserCreate, UserView
